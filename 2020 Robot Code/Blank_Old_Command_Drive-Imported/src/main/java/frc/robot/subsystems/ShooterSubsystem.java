...
public class ShooterSubsystem extends Subsystem {
  ...
  public AnalogInput ultraSonic2 = new AnalogInput(RobotMap.ultraSonicPort2);
  ...
  double sensorValue2 = ultraSonic2.getVoltage();
  double distance2 = 5*sensorValue2*scaleFactor; //convert the voltage to distance
  SmartDashboard.putNumber("DB/Slider 2", distance2); //write the value to the LabVIEW DriverStation
  }
